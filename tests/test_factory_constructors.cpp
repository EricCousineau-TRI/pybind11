...
#define MAKE_TAG_TYPE(Name) \
    ...
    using PyTF7_wrapped = py::wrapper<PyTF7>;
    py::class_<TestFactory7, PyTF7_wrapped, std::shared_ptr<TestFactory7>>(m, "TestFactory7")
        .def(py::init(
            [](int i) { return TestFactory7(i); },
            [](int i) { return PyTF7_wrapped(i); }))
        .def(py::init(
            [](pointer_tag, int i) { return new TestFactory7(i); },
            [](pointer_tag, int i) { return new PyTF7_wrapped(i); }))
        .def(py::init(
            [](mixed_tag, int i) { return new TestFactory7(i); },
            [](mixed_tag, int i) { return PyTF7_wrapped(i); }))
        .def(py::init(
            [](mixed_tag, std::string s) { return TestFactory7((int) s.size()); },
            [](mixed_tag, std::string s) { return new PyTF7_wrapped((int) s.size()); }))
        .def(py::init(
            [](base_tag, pointer_tag, int i) { return new TestFactory7(i); },
            [](base_tag, pointer_tag, int i) { return (TestFactory7 *) new PyTF7_wrapped(i); }))
        .def(py::init(
            [](alias_tag, pointer_tag, int i) { return new PyTF7_wrapped(i); },
            [](alias_tag, pointer_tag, int i) { return new PyTF7_wrapped(10*i); }))
        .def(py::init(
            [](shared_ptr_tag, base_tag, int i) { return std::make_shared<TestFactory7>(i); },
            [](shared_ptr_tag, base_tag, int i) { auto *p = new PyTF7_wrapped(i); return std::shared_ptr<TestFactory7>(p); }))
        .def(py::init(
